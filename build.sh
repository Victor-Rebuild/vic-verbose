...
if [[ ! -d $HOME/.anki/vicos-sdk/dist/$TOOLCHAIN_VER ]]; then
  echo "Getting toolchain version $TOOLCHAIN_VER..."
  mkdir -p $HOME/.anki/vicos-sdk/dist/$TOOLCHAIN_VER
  cd $HOME/.anki/vicos-sdk/dist/$TOOLCHAIN_VER
...
TC="$HOME/.anki/vicos-sdk/dist/$TOOLCHAIN_VER/prebuilt/bin/arm-oe-linux-gnueabi-"
